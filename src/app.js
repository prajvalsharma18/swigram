...
app.get('/', (req, res) => sendAuthenticationPage(res));
app.get(['/authentication', '/authentication/'], (req, res) => sendAuthenticationPage(res));
app.get(['/reels', '/reels/'], (req, res) => sendReelsPage(res));
